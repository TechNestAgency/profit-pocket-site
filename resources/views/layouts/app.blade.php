...
<head>
    ...
    <meta name="description" content="@yield('description', $settings['site_description'] ?? 'البوصلة التي توجه المستثمر من ضبابية السوق إلى وضوح النتائج المضمونة')">
    ...
    <meta property="og:description" content="@yield('description', $settings['site_description'] ?? 'البوصلة التي توجه المستثمر من ضبابية السوق إلى وضوح النتائج المضمونة')">
    ...
    <meta name="twitter:description" content="@yield('description', $settings['site_description'] ?? 'البوصلة التي توجه المستثمر من ضبابية السوق إلى وضوح النتائج المضمونة')">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <p class="text-gray-300 mb-4">
                            {{ $settings['site_description'] ?? 'البوصلة التي توجه المستثمر من ضبابية السوق إلى وضوح النتائج المضمونة' }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-6">
                            ...
                            <div class="flex flex-wrap gap-2">
                                ...
                                <a href="{{ $socialSettings['facebook_url'] }}" target="_blank" class="bg-blue-600 text-white p-3 rounded-xl hover:bg-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-110">
                                ...
                                <a href="{{ $socialSettings['telegram_url'] }}" target="_blank" class="bg-blue-500 text-white p-3 rounded-xl hover:bg-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-110">
                                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="{{ $socialSettings['snapchat_url'] }}" target="_blank" class="bg-yellow-500 text-white p-3 rounded-xl hover:bg-yellow-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-110">
                                    <img src="{{ asset('snapchat.png') }}" alt="Snapchat" class="w-6 h-6">
                                </a>
                                @endif
                                
                                @if($socialSettings['youtube_url'] ?? null)
                                <a href="{{ $socialSettings['youtube_url'] }}" target="_blank" class="bg-red-600 text-white p-3 rounded-xl hover:bg-red-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-110">
                                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="{{ $socialSettings['twitter_url'] }}" target="_blank" class="bg-black text-white p-3 rounded-xl hover:bg-gray-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-110">
                                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                @if($socialSettings['tiktok_url'] ?? null)
                                <a href="{{ $socialSettings['tiktok_url'] }}" target="_blank" class="bg-black text-white p-3 rounded-xl hover:bg-gray-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-110">
                                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
