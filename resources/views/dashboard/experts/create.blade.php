...
@section('title', 'إضافة خبير جديد - لوحة التحكم')
@section('page-title', 'إضافة خبير جديد')
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
    <div class="flex items-center">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">إضافة خبير جديد</h1>
            <p class="text-gray-600 mt-1">إضافة خبير جديد إلى الموقع</p>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
    <form method="POST" action="{{ route('dashboard.experts.store') }}" enctype="multipart/form-data" class="p-6">
        @csrf
        ...
        <!-- Image -->
        <div class="mb-6">
            <label for="image" class="block text-sm font-medium text-gray-700 mb-2">صورة الخبير</label>
