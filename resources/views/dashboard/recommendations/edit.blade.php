            ...
            <div class="mb-6">
                ...
                <div id="new-multiple-images-preview" class="mb-4 hidden">
                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3" id="new-images-preview-grid">
                            <!-- Preview images will be added here -->
                        </div>
                        <p class="text-sm text-gray-600 mt-3 text-center">معاينة الصور الجديدة (<span id="new-image-count">0</span> صورة)</p>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePreview() {
        ...
        // Update image count
        const imageCountElement = document.getElementById('new-image-count');
