...
@section('title', 'إدارة الشهادات - لوحة التحكم')
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600 mt-1">إدارة وتحرير شهادات العملاء</p>
        </div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <div class="flex items-center">
                                @if($testimonial->image)
                                    <div class="flex-shrink-0 h-12 w-12">
                                        <img class="h-12 w-12 rounded-lg object-cover" src="{{ asset($testimonial->image) }}" alt="{{ $testimonial->name }}">
                                    </div>
                                @else
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900">{{ Str::limit($testimonial->opinion, 80) }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
    ...
    @else
        <div class="text-center py-12">
            ...
            <h3 class="text-xl font-semibold text-gray-900 mb-2">لا توجد شهادات</h3>
            <p class="text-gray-600 mb-6">ابدأ بإضافة أول شهادة</p>
            <a href="{{ route('dashboard.testimonials.create') }}" 
