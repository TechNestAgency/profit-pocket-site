...
@section('title', 'تعديل الفيديو - لوحة التحكم')
@section('page-title', 'تعديل الفيديو')
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">تعديل الفيديو</h1>
            <p class="text-gray-600 mt-1">تعديل معلومات الفيديو في قسم الفيديو</p>
        </div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
    <form method="POST" action="{{ route('dashboard.video-section.update', $videoSection->id) }}">
        @csrf
        @method('PUT')
        ...
        <div class="mb-6">
            ...
            <input type="url" 
                   id="youtube_url" 
                   name="youtube_url" 
                   value="{{ old('youtube_url', $videoSection->youtube_url) }}"
        ...
        <div class="mb-6">
            ...
            <div id="video-preview" class="bg-gray-100 rounded-lg p-4">
