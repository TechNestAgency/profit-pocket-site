...
@section('title', 'تحرير الخدمة - لوحة التحكم')
@section('page-title', 'تحرير الخدمة')
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
    <div class="flex items-center">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">تحرير الخدمة</h1>
            <p class="text-gray-600 mt-1">تحرير بيانات الخدمة: {{ $service->title }}</p>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
    <form method="POST" action="{{ route('dashboard.services.update', $service->id) }}" enctype="multipart/form-data" class="p-6">
        @csrf
        @method('PUT')
        ...
        <div class="mb-6">
            <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                {{ $service->image ? 'تغيير الصورة' : 'إضافة صورة' }}
            </label>
