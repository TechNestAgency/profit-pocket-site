...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600 mt-1">إدارة وتحرير خدمات الموقع</p>
        </div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                            ...
                            <div class="flex items-center">
                                @if($service->image)
                                    <div class="flex-shrink-0 h-12 w-12">
                                        <img class="h-12 w-12 rounded-lg object-cover" src="{{ asset('storage/' . $service->image) }}" alt="{{ $service->title }}">
                                    </div>
                                @else
                                ...
                                <div class="mr-4">
                                    ...
                                    <div class="text-sm text-gray-500">{{ $service->created_at->format('Y/m/d') }}</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900">{{ Str::limit($service->description, 80) }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
    ...
    @else
        <div class="text-center py-12">
            ...
            <h3 class="text-xl font-semibold text-gray-900 mb-2">لا توجد خدمات</h3>
            <p class="text-gray-600 mb-6">ابدأ بإضافة أول خدمة</p>
            <a href="{{ route('dashboard.services.create') }}" 
