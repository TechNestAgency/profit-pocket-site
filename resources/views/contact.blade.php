            ...
            <div>
                ...
                <form class="space-y-6" method="POST" action="{{ route('contact.store') }}">
                    ...
                    <div>
                        ...
                        <input type="tel" id="phone" name="phone" value="{{ old('phone') }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent @error('phone') border-red-500 @enderror" placeholder="+966 50 123 4567" required>
                        @error('phone')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div>
                ...
                <div class="mt-8">
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <a href="{{ $socialSettings['facebook_url'] }}" target="_blank" class="bg-blue-600 text-white p-4 rounded-xl hover:bg-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-110">
                        ...
                        <a href="{{ $socialSettings['telegram_url'] }}" target="_blank" class="bg-blue-500 text-white p-4 rounded-xl hover:bg-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-110">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ $socialSettings['snapchat_url'] }}" target="_blank" class="bg-yellow-500 text-white p-4 rounded-xl hover:bg-yellow-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-110">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ $socialSettings['youtube_url'] }}" target="_blank" class="bg-red-600 text-white p-4 rounded-xl hover:bg-red-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-110">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ $socialSettings['twitter_url'] }}" target="_blank" class="bg-black text-white p-4 rounded-xl hover:bg-gray-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-110">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ $socialSettings['tiktok_url'] }}" target="_blank" class="bg-black text-white p-4 rounded-xl hover:bg-gray-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-110">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
